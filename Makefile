...
SIMAPP = ./app
HTTPS_GIT := https://github.com/sagaxyz/ethermint.git
...
PACKAGE_NAME:=github.com/sagaxyz/ethermint
...
godocs:
	@echo "--> Wait a few seconds and visit http://localhost:6060/pkg/github.com/sagaxyz/ethermint/types"
	godoc -http=:6060
...
test-import:
	go test -run TestImporterTestSuite -v --vet=off github.com/sagaxyz/ethermint/tests/importer
